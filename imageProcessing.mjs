...
const S3_ORIGINAL_IMAGE_BUCKET = Resource.ContentAssetBucketOriginal.name;
const S3_TRANSFORMED_IMAGE_BUCKET = Resource.ContentAssetBucketTransformed.name;
const TRANSFORMED_IMAGE_CACHE_TTL =
  process.env.transformedImageCacheTTL || "max-age=31536000";
const MAX_IMAGE_SIZE = parseInt(process.env.maxImageSize || 6 * 1024 * 1024);
